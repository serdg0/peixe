                    ...
                    <Card key={peli.Title}>
                        ...
                        <Card.Body>
                            ...
                            <ListGroup className="list-group-flush">
                                <ListGroupItem>Director: {peli.Director}</ListGroupItem>
                                <ListGroupItem>Actores: {peli.Actors}</ListGroupItem>
                                <ListGroupItem>Premios: {peli.Awards}</ListGroupItem>
                                <ListGroupItem>Lanzamiento: {peli.Released}</ListGroupItem>
                                <ListGroupItem>Rating IMDB: {peli.imdbRating}</ListGroupItem>
                            </ListGroup>
                        </Card.Body>
                    </Card>
                    </Col>
